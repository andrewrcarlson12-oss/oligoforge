...
trace_path=Path(__file__).resolve().parent/"benchmark"/"plasmodium_ranking_trace.json.gz"
trace_bytes=trace_path.read_bytes()
check("biological trace compression is deterministic",
      trace_bytes[:2]==b"\x1f\x8b" and trace_bytes[4:8]==b"\x00\x00\x00\x00",
      trace_bytes[:10])
with gzip.open(trace_path,"rt",encoding="utf-8") as trace_handle:
