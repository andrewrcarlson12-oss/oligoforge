...
ctx.api=async(path)=>({"/api/conditions":{mv_conc:50,dv_conc:3,dntp_conc:0.8,dna_conc:200},"/api/report":{html:"<html>r</html>",csv:"a,b",n_assays:5},"/api/multiplex":{n_assays:5,n_oligos:14,threshold:-6,channel_conflicts:[{dye:"FAM",assays:["IFNG","IL4"]}],cross_dimers:[],n_flagged:0}}[path]||{});
